...
local secret = secretstring("t5XDvY88x3u5zJt8wL7G0HWZw8yq3Z7o3dHg01GjplqlpqqU");  -- make sure to obfuscate this if you want to ensure security.
...
local Swift = Instance.new("ScreenGui", gethui())
...
function LoadExploit()
    ...
    local Main = createInstance("Frame", {
        Position = UDim2.new(0.254, 0.000, 0.238, 0.000),
        Size = UDim2.new(0.492, 0.000, 0.526, 0.000),
        Parent = Swift,
        BackgroundColor3 = Color3.fromRGB(20, 20, 20),
        BorderSizePixel = 0,
        ZIndex = 1
    ...
    local Logo = createInstance("ImageLabel", {
        Position = UDim2.new(0.019, 0.000, 0.034, 0.000),
        Size = UDim2.new(0.062, 0.000, 0.075, 0.000),
        Parent = Main,
        BackgroundTransparency = 1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ImageColor3 = Color3.fromRGB(255, 255, 255),
    ...
    local Titile = createInstance("TextLabel", {
        Position = UDim2.new(0.136, 0.000, -0.001, 0.000),
        Size = UDim2.new(0.077, 0.000, 0.111, 2.000),
        Parent = Main,
        BackgroundTransparency = 1,
        AnchorPoint = Vector2.new(0.5, 0),
        Font = Enum.Font.SourceSans,
    ...
    local Div = createInstance("Frame", {
        Position = UDim2.new(0.500, 0.000, 0.113, 0.000),
        Size = UDim2.new(1.000, 0.000, 0.000, 2.000),
        Parent = Main,
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundColor3 = Color3.fromRGB(25, 25, 25),
    ...
    local UISizeConstraint = createInstance("UISizeConstraint", {
        Parent = Div,
        MaxSize = Vector2.new(INF, 2),
        MinSize = Vector2.new(0, 2)
    })

    local UIAspectRatioConstraint_1 = createInstance("UIAspectRatioConstraint", {
        AspectRatio = 1.735,
        Parent = Main
    })

    local Editor = createInstance("TextBox", {
        Position = UDim2.new(0.071, 0.000, 0.174, 0.000),
        Size = UDim2.new(0.000, 923.000, 0.000, 466.000),
        Parent = Main,
        ClearTextOnFocus = false,
        BackgroundTransparency = 1,
        Font = Enum.Font.SourceSans,
        ...
        TextWrapped = true,
        TextColor3 = Color3.fromRGB(178, 178, 178),
        PlaceholderText = 'print("Swift on top")',
        PlaceholderColor3 = Color3.fromRGB(178, 178, 178),
        BackgroundColor3 = Color3.fromRGB(0, 0, 0),
        TextSize = 14,
        BorderSizePixel = 0,
    ...
    local Frame = createInstance("Frame", {
        Position = UDim2.new(0.048, 0.000, 0.143, 0.000),
        Size = UDim2.new(0.906, 0.000, 0.808, 0.000),
        Parent = Main,
        BackgroundTransparency = 0.5,
        BackgroundColor3 = Color3.fromRGB(0, 0, 0),
        BorderSizePixel = 0,
    ...
    local Clear = createInstance("ImageButton", {
        Position = UDim2.new(0.926, 0.000, 0.013, 0.000),
        Size = UDim2.new(0.050, 0.000, 0.072, 0.000),
        Parent = Main,
        BackgroundTransparency = 0.5,
        AutoButtonColor = false,
        AnchorPoint = Vector2.new(0.5, 0),
    ...
    local ImageLabel = createInstance("ImageLabel", {
        Position = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Size = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Parent = Clear,
        BackgroundTransparency = 1,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ImageColor3 = Color3.fromRGB(150, 150, 150),
        Image = "rbxassetid://10747362393",
        BorderSizePixel = 0,
        ZIndex = 513
    })

    local Frame_4 = createInstance("Frame", {
        Position = UDim2.new(0.000, 0.000, 1.000, 0.000),
        Size = UDim2.new(1.000, 0.000, 0.000, 1.000),
        Parent = Clear,
        BackgroundTransparency = 0.5,
    ...
    local ButtonHolder = createInstance("Frame", {
        Position = UDim2.new(0.670, 0.000, 0.002, 0.000),
        Size = UDim2.new(0.277, 0.000, 0.114, 0.000),
        Parent = Main,
        BackgroundTransparency = 1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BorderSizePixel = 0,
    ...
    local ClipboardButton = createInstance("ImageButton", {
        Position = UDim2.new(0.940, 0.000, 0.165, 0.000),
        Size = UDim2.new(0.700, 0.000, 0.700, 0.000),
        Parent = ButtonHolder,
        AutoButtonColor = false,
        BackgroundTransparency = 0.5,
        AnchorPoint = Vector2.new(0.5, 0),
    ...
    local UIAspectRatioConstraint_5 = createInstance("UIAspectRatioConstraint", {
        AspectRatio = 1.000,
        Parent = ClipboardButton
    })

    local ImageLabel_6 = createInstance("ImageLabel", {
        Position = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Size = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Parent = ClipboardButton,
        BackgroundTransparency = 1,
        ...
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ImageColor3 = Color3.fromRGB(150, 150, 150),
        Image = "rbxassetid://10709798890",
        BorderSizePixel = 0,
        ZIndex = 513
    })

    local Frame_7 = createInstance("Frame", {
        Position = UDim2.new(0.000, 0.000, 1.000, 0.000),
        Size = UDim2.new(1.000, 0.000, 0.000, 1.000),
        Parent = ClipboardButton,
        BackgroundTransparency = 0.5,
    ...
    local Clear_8 = createInstance("Frame", {
        Position = UDim2.new(0.940, 0.000, 0.165, 0.000),
        Size = UDim2.new(0.700, 0.000, 0.700, 0.000),
        Parent = ButtonHolder,
        BackgroundTransparency = 0.5,
    ...
    local ImageLabel_10 = createInstance("ImageLabel", {
        Position = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Size = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Parent = Clear_8,
        BackgroundTransparency = 1,
        ...
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ImageColor3 = Color3.fromRGB(150, 150, 150),
        Image = "rbxassetid://10723346158",
        BorderSizePixel = 0,
        ZIndex = 513
    })

    local Frame_11 = createInstance("Frame", {
        Position = UDim2.new(0.000, 0.000, 1.000, 0.000),
        Size = UDim2.new(1.000, 0.000, 0.000, 1.000),
        Parent = Clear_8,
        BackgroundTransparency = 0.5,
    ...
    local Exec = createInstance("ImageButton", {
        Position = UDim2.new(0.940, 0.000, 0.165, 0.000),
        Size = UDim2.new(0.700, 0.000, 0.700, 0.000),
        Parent = ButtonHolder,
        AutoButtonColor = false,
    ...
    local UIAspectRatioConstraint_12 = createInstance("UIAspectRatioConstraint", {
        AspectRatio = 1.000,
        Parent = Exec
    })
    ...
    local Frame_14 = createInstance("Frame", {
        Position = UDim2.new(0.000, 0.000, 1.000, 0.000),
        Size = UDim2.new(1.000, 0.000, 0.000, 1.000),
        Parent = Exec,
        BackgroundTransparency = 0.5,
    ...
    local Card = createInstance("ImageButton", {
        Position = UDim2.new(0.105, 0.000, 0.306, 0.000),
        Size = UDim2.new(0.000, 47.000, 0.000, 44.000),
        Parent = Swift,
        BackgroundColor3 = Color3.fromRGB(20, 20, 20),
        BorderSizePixel = 0,
        AutoButtonColor = false,
    ...
    local CardImg = createInstance("ImageLabel", {
        Position = UDim2.new(0.500, 0.000, 0.500, 0.000),
        Size = UDim2.new(0.700, 0.000, 0.700, 0.000),
        Parent = Card,
        BackgroundTransparency = 1,
    ...
    local imgcons = createInstance("UIAspectRatioConstraint", {
        AspectRatio = 2.608,
        Parent = CardImg
    })
    
    local CardCons = createInstance("UIAspectRatioConstraint", {
        AspectRatio = 1.000,
        Parent = Card
    })
    ...
    ClipboardButton.MouseButton1Click:Connect(function()
        executeclipboard() -- // Check
    end)

    Exec.MouseButton1Click:Connect(function()
        run_script(Editor.Text) -- // Check
    end)
